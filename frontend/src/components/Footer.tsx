        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Secure, decentralized peer-to-peer cryptocurrency exchange platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Fees</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Security</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Market Prices</a></li>
            </ul>
          </div>
